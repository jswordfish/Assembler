; 1ST ZONE TEMP CONTROLLING AS PER NEW PROGRAM
;NAMED VERSION AS 200.2
;LAST EDITED ON 23/4/2015
;ADDED PROGRAM FOR BLOWER & BLOW PIN HYDRAULIC / PNEUMATIC M/C
;-----------------------------------------------------
;BLOW PIN DOWN TIMER ADD
;BLOW PIN HYDRAULIC
...
BLOW_PINUP_OP             EQU    3DH   ;BLOWING
CUTTER2_OP                EQU    3EH   ;CUTTER 1
...
TM101E                    EQU    42H
PINDN_TM101E              EQU    42H

TM101D                    EQU    43H
PINDN_TM101D              EQU    43H

TM102E                    EQU    44H
PINDN_SLOW_TM102E         EQU    44H

TM102D                    EQU    45H
PINDN_SLOW_TM102D         EQU    45H

TM103E                    EQU    46H
PINUP_SLOW_TM103E         EQU    46H

TM103D                    EQU    47H
PINUP_SLOW_TM103D         EQU    47H
...
MOULD_OUT_PB_IP           EQU    53H     ;INP11
BLOW_PINUP_PB_IP          EQU    54H     ;INP12
...
RLY17_24                  EQU    2DH
;-----------------------------------
MOULD_IN_OVER              EQU    68H
MOULD_CLOSE_OVER           EQU    69H                 
MOULD_OUT_OVER             EQU    6AH
BLOW_PIN_DN_OVER           EQU    6BH
PARISON_START              EQU    6CH
PARISON_SEL                EQU    6DH
;RLY21                     EQU    6CH
;RLY22                     EQU    6DH
;RLY23                     EQU    6EH
...
TMS101H                     EQU   107AH   ;62  BLOW PIN DOWN TIME
TMS101L                     EQU   107BH

TMS102H                     EQU   107CH   ;63  PIN DN SLOW
TMS102L                     EQU   107DH

TMS103H                     EQU   107EH   ;64  PIN DN SLOW
TMS103L                     EQU   107FH
...
BLOWER4_H                   EQU   2006H   ;2052
BLOWER4_L                   EQU   2007H

CTC00H                      EQU   2300H   ;2433   MAIN PROD_VINAYAK PROD RESET LINK
CTC00L                      EQU   2301H

CTC01H                      EQU   2302H   ;2434   MAIN PROD
CTC01L                      EQU   2303H

CTC02H                      EQU   2304H   ;2435  HOURLY PROD COUNT
CTC02L                      EQU   2305H
...
ZONE1_PREV_H                EQU   24CAH    ;2678
ZONE1_PREV_L                EQU   24CBH
...
RLY545                       EQU    0E1H
BLOW_PINUP_PB                EQU    0E1H

RLY546                       EQU    0E2H
SMALL_PUMP_PB                EQU    0E2H

RLY547                       EQU    0E3H
BIG_PUMP_PB                  EQU    0E3H

RLY548                       EQU    0E4H
PARISON_THIN_PB              EQU    0E4H


RLY549                       EQU    0E5H
PARISON_THICK_PB             EQU    0E5H


RLY550                       EQU    0E6H
PARISON_SEL_BIT              EQU    0E6H
...
TM104_ENABLE           EQU   05FC6H
RLY1584_1591           EQU   05FC6H

TM104E                  EQU   0E0H
BLOWPINUP_DELAY_TM104E  EQU   0E0H

TM104D                  EQU   0E1H
BLOWPINUP_DELAY_TM104D  EQU   0E1H

TM105E                  EQU   0E2H
MOULD_OPEN_SLOW_TM105E  EQU   0E2H

TM105D                  EQU   0E3H
MOULD_OPEN_SLOW_TM105D  EQU   0E3H
...
;-----------------------------------------------------
   ...
   MOV   DPTR,#TEMP_IP_12_L             
   MOVX  A,@DPTR
   MOV   R4,A
   MOV   DPTR,#TEMP_IP_12_H                    
   MOVX  A,@DPTR
   MOV   R5,A
   ANL   A,#70H
   SWAP  A
...
;---------------------------------------------------------------------   
   ...
   MOV   DPTR,#TMS103H
   MOVX  A,@DPTR
   CJNE  A,B,CHK_TMC103H                 ;TMR00_NOT_DONE
	SJMP  CHK_TMC103L
   ...
   MOVX	A,@DPTR                               ;A,TMC00L
	...
	MOV   DPTR,#TMS103L
	MOVX  A,@DPTR
	CJNE  A,B,CHECK_CARRY_TM103
	SJMP  SET_TMR103_DONE
...
;---------------------------------------------------   
   ...
   MOV   DPTR,#TMS104H
   MOVX  A,@DPTR
   CJNE  A,B,CHK_TMC104H                    ;TMR00_NOT_DONE
	SJMP  CHK_TMC104L
...
;---------------------------------------------------------------
   ...
   MOV   DPTR,#TMS105H
   MOVX  A,@DPTR
   CJNE  A,B,CHK_TMC105H                    ;TMR00_NOT_DONE
	SJMP  CHK_TMC105L
...
;-------------------------------------------- 
   ...
   MOV   DPTR,#TMS106H
   MOVX  A,@DPTR
   CJNE  A,B,CHK_TMC106H                    ;TMR00_NOT_DONE
	SJMP  CHK_TMC106L
...
;-------------------------------------------------------   
   ...
   MOV   DPTR,#TMS107H
   MOVX  A,@DPTR
   CJNE  A,B,CHK_TMC107H                    ;TMR00_NOT_DONE
	SJMP  CHK_TMC107L
...
;--------------------------------
   ...
   JNB	TM32E,TMR32_NOT_ENABLED
	...
	JNB   HUND_MSEC_BIT,TM33_HANDLER
   CLR	C
   MOV   DPTR,#TMC32L	
	MOVX	A,@DPTR
	SUBB	A,#01
...
;----------------------------------------------
   ...
   JNB	TM33E,TMR33_NOT_ENABLED
	...
	JNB   HUND_MSEC_BIT,TM34_HANDLER
   CLR	C
   MOV   DPTR,#TMC33L	
	MOVX	A,@DPTR
	SUBB	A,#01
...
;----------------------------------------------------------------------------
 ...
 ; ANL    C,B_HOME_POSN
  ANL    C,EMERGENCY_IP
  ORL    C,/EMERGENCY_IP
  JNC    MOULD_IN_DLY_NOT_STARTED
  SETB   MOULDIN_DLY_TM14E       ;TM14E IS MOULD IN DELAY

  MOULD_IN_DLY_NOT_STARTED:  
;---------------------------------------------------------------------  
  MOV    C,AUTO_MAN_SEL
  ANL    C,/MOULD_IN_OVER                                                     
  ANL    C,B_HOME_POSN
  ANL    C,MOULDIN_DLY_TM14D            
  MOV    RLY39,C
...
;----------------------------------------------------------------------------- 
  ...
  MOV    C,MLD_CLS_TM_D
  ANL    C,AUTO_MAN_SEL
  ANL    C,MOULD_CLOSE_DLY_TM01D
  JNC    MOULD_CLOSE_NOT_OVER
  SETB   MOULD_CLOSE_OVER
  
  MOULD_CLOSE_NOT_OVER:
...
;CUTTER DELAY
;----------------------------------------------------------------------------
  MOV    C,MOULD_CLOSE_DLY_TM01D            ;TM01 IS MOULD CLOSE DELAY
  ANL    C,AUTO_MAN_SEL
  ANL    C,EMERGENCY_IP
  JNC    CUTTER_DELAY_NOT_STARTED
  SETB   CUTTER_DLY_TM02E      
  
  CUTTER_DELAY_NOT_STARTED:
 
 
  MOV    C,TM02E
  ANL    C,/TM02D  
  JNC    DO_NOT_LOAD_CYCLE_TIME
  
  JNB    TM16E,DO_NOT_LOAD_CYCLE_TIME
  MOV    DPTR,#TMC16H
  MOVX   A,@DPTR
...
;--------------------------------------------------------------------------- 
  ...
  MOV    CUTTER_ON_TM03E,C          ;TM03 IS CUTTER ON TIME
  JNC    CUTTER_TIME_NOT_ON
  SETB   PARISON_DLY_TM12E
  SETB   TM16E    ;TM16E IS CYCLE TIME
...
;---------------------------------------------------------------------------  
   ...
   JNC   CUTTER_DELAY_OVER                                        ;DO_NOT_RESET_EXTRUDER_TIMER
...
;-----------------------------------------------------------------------
  MOV    C,CUTTER_DLY_TM02D
  ANL    C,AUTO_MAN_SEL
  ANL    C,MOULD_CLOSE_OVER                              ;MLD_CLS_TM_D
  MOV    MOULDOUT_DLY_TM19E,C
  
  MOV    C,MOULDOUT_DLY_TM19D                                        
  ANL    C,BLOW_PINUP_IP     
  ANL    C,AUTO_MAN_SEL  
  ANL    C,/MOULD_OUT_OVER                            ;MOULD_OUT_IP    
  MOV    RLY39,C
...
;-------------------------------------------------------------------------  
  ...
  MOV    BLOW_PINDN_OP,C  
;----------------------------------------------------------------------------
;PIN DN ON TIME STARTS FROM HERE
;----------------------------------------------------------------------------
  MOV    C,AUTO_MAN_SEL
  ANL    C,BLOW_PIN_DN_DLY_TM04D
  MOV    PINDN_TM101E,C
;---------------------------------
;PIN DN SLOW TIMER START FROM HERE
;--------------------------------  
  MOV    C,BLOW_PINDN_OP 
  MOV    PINDN_SLOW_TM102E,C      
...
;-------------------------------------------------------------------------
;BLOW PIN UP DELAY STARTS FROM HERE
;-------------------------------------------------------------------------
  MOV    C,AUTO_MAN_SEL
  ANL    C,EXHAUST_TM08D
  ANL    C,MOULD_OPEN_IP
...
;----------------------------------
  ...
  MOV    BLOW_PINUP_OP,C
;-----------------------------------------
;PIN UP SLOW DN TIMER START
;-----------------------------------------  
  MOV    C,BLOW_PINUP_OP 
  MOV    PINUP_SLOW_TM103E,C    
...
;----------------------------------------- 
 ;MOULD OPEN SLOW DOWN
;------------------------------------------ 
 MOV    C,MOULD_OPEN_OP
 MOV    DPTR,#TM104_ENABLE 
 MOVX   A,@DPTR
 MOV    MOULD_OPEN_SLOW_TM105E,C  
 MOVX   @DPTR,A
...
;------------------------------------
  ...
  MOV     A,OUT16_23
  MOV     THICK_OP,C
  MOV     OUT16_23,A                                 ;PARISON_THICK_OP,C
...
;----------------------------------------------------------------------
   ...
   JNC   TEMP_LESS_THAN_SET  ;ACTUAL TEMP IS LESS THAN SET HENCE ON TIME =0
	...
	MOV   A,R6
	CJNE  A,BAND,CHECK_LESS_THAN_TEN_Z1
   SETB  C
...
;---------------------------------------	
   ...
   JNB   RLY33,CHECK_INCREASING_TREND
   
   MOV   DPTR,#ZONE1_ACT_TEMP_H
   MOVX  A,@DPTR
   MOV   DPTR,#ZONE1_PREV_H
   MOVX  @DPTR,A   
   MOV   DPTR,#ZONE1_ACT_TEMP_L
   MOVX  A,@DPTR
   MOV   DPTR,#ZONE1_PREV_L
   MOVX  @DPTR,A   
   SETB  C
   SJMP  HEATER1_OFF
...
;--------------------------------------------------------
   ...
   CJNE  A,#1,CHK_LIMIT_BLOWER3
   MOV   DPTR,#BLOWER2_L
	MOVX  A,@DPTR
	MOV   R5,A
	MOV   DPTR,#ZONE2_ACT_TEMP_L
   MOVX	A,@DPTR	
	CLR	C
	SUBB	A,R5
	MOV	NUM1L,A
...
;--------------------------------------------
   ...
   CJNE  A,#2,CHK_LIMIT_BLOWER4
   MOV   DPTR,#BLOWER3_L
	MOVX  A,@DPTR
	MOV   R5,A
	MOV   DPTR,#ZONE3_ACT_TEMP_L
   MOVX	A,@DPTR	
	CLR	C
	SUBB	A,R5
	MOV	NUM1L,A
...
;------------------------------------------------------        
   ...
   CJNE  A,#3,CHK_LIMIT_BLOWER5
   MOV   DPTR,#BLOWER4_L
	MOVX  A,@DPTR
	MOV   R5,A
	MOV   DPTR,#ZONE4_ACT_TEMP_L
   MOVX	A,@DPTR	
	CLR	C
	SUBB	A,R5
	MOV	NUM1L,A
...
;------------------------------------------   
   MOV   DPTR,#RLY520_527
   MOVX  A,@DPTR
   JNB   PROD_CNT_RST,DO_NOT_RESET_HOURLY_COUNTER
   CLR   A
   MOV   DPTR,#CTC02H
   MOVX  @DPTR,A
   INC   DPTR
